...
5. [Think Stats Chapter 7 Exercise 1](statistics/7-1-weight_vs_age.md) (weight vs. age)
6. [Think Stats Chapter 8 Exercise 2](statistics/8-2-sampling_dist.md) (sampling distribution)

The following exercises are optional, but we highly encourage you to complete them if you have the time.

1. [Think Stats Chapter 6 Exercise 1](statistics/6-1-household_income.md) (household income)
2. [Think Stats Chapter 8 Exercise 3](statistics/8-3-scoring.md) (scoring)
3. [Think Stats Chapter 9 Exercise 2](statistics/9-2-resampling.md) (resampling)
